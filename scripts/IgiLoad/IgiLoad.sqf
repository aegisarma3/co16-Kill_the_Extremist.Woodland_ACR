...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["B_mas_afr_Offroad_01_F", "C_Offroad_01_F", "B_G_Offroad_01_F"];
	...
	IL_Supported_Vehicles_KAMAZ = ["bts_caminhao_fl", "bts_caminhao_coberto_fl","I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	...
	IL_Supported_Hummvee = ["rc_hmmwv", "HMMWV2", "HMMWV_M1035", "M1114_AGS_ACR", "HMMWV_M1151_M2", "HMMWV2_M2", "HMMWV2_MK19", "HMMWV2_TOW", "HMMWV", "HMMWV_M2", "HMMWV_MK19", "HMMWV_TOW", "DAR_M1151", "DAR_M1151_Deploy", "DAR_M115_MK19", "DAR_M1167", "DAR_M1152", "DAR_M1165_GMV", "DAR_M1151Woodland", "DAR_M115_MK19Woodland", "DAR_M1167Woodland", "DAR_M1152Woodland", "DAR_M1151WoodlandUA"];
	...
	IL_Supported_Box_H2 = ["Land_Sacks_goods_F", "Land_Sacks_heap_F", "Land_Sack_F", "Box_NATO_AmmoOrd_F", "Box_East_AmmoOrd_F", "Box_IND_AmmoOrd_F", "Box_NATO_Grenades_F", "Box_East_Grenades_F", "Box_IND_Grenades_F", "Box_NATO_Ammo_F", "Box_East_Ammo_F", "Box_IND_Ammo_F", "Box_IND_Support_F", "Box_East_Support_F", "Box_NATO_Support_F"];
	//TODO
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Eject</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Unload ALL cargo with parachute</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from HEMTT</t>",
	{
